...
const Wishlist = () => {
            ...
            fetch(`http://localhost:5000/wishlist/${_id}`, {
              ...
              .then((data) => {
                if (data.deletedCount > 0) {
                  ...
                  setData(data.filter((blog) => blog._id !== _id));
                } else {
                  Swal.fire({
                    title: "Error!",
  ...
  return (
    <div id="recent-blogs" className="bg-black/80 bg-[url('https://i.postimg.cc/sgNF6ptt/retrosupply-j-Lw-VAUt-LOAQ-unsplash.jpg')] bg-cover bg-center bg-blend-darken p-8 md:p-16 flex flex-col justify-center items-center py-24">
      <h1
        data-aos="flip-up"
